//! rustls configuration shared by the FTPS backend.
...
/// Accepts every server certificate. Only used when the user explicitly enabled
/// "accept invalid certificates" for a site (e.g. self-signed certificates).
#[derive(Debug)]
